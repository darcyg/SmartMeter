...
#define phase_1_active_energy_pulse_start()         (P8OUT &= ~BIT6)
#define phase_1_active_energy_pulse_end()           (P8OUT |= BIT6)
...
/*! The gain setting for the second current channel channel of the SD16,
    ...
    shunt are GAIN_16 (x16 gain) or GAIN_32 (x32 gain). Typical values for a
    CT are GAIN_1 (x1 gain) or GAIN_2 (x2 gain). */
#define CURRENT_NEUTRAL_GAIN                        SD24GAIN_4
...
#define DEFAULT_V_RMS_SCALE_FACTOR_A                10073
...
#define DEFAULT_I_RMS_SCALE_FACTOR_A                6123
...
#if 1
#define DEFAULT_P_SCALE_FACTOR_A_LOW                7707        /* Low current, high gain, range. Test at 2A on 30A max meter */
...
#define DEFAULT_BASE_PHASE_A_CORRECTION_LOW         0x0318   /* Low current, high gain, range. Test at 2A on 30A max meter. */
...
#define DEFAULT_NEUTRAL_BASE_PHASE_CORRECTION       0x0170
...
/*
    ...
    P2.7 =                        - BT2
 */
#define P2DIR_INIT                                  (BIT5 | BIT4 | BIT3 | BIT2)
#define P2SEL_INIT                                  (BIT1 | BIT0)
#define P2OUT_INIT                                  (0)
#define P2REN_INIT                                  (0)
...
/*
    ...
    P8.7 = LED 2
 */
#define P8DIR_INIT                                  (BIT7 | BIT6 | BIT5 | BIT4)
#define P8SEL_INIT                                  0
#define P8OUT_INIT                                  (BIT7 | BIT6)
#define P8REN_INIT                                  0
