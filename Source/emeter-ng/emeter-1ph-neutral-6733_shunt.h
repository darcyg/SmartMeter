...
/*! Tiny power levels should not record at all, as they may just be rounding errors,
    ...
    in 0.01W increments. */
#define RESIDUAL_POWER_CUTOFF                       1
...
/*! The hall effect sensors used to detect magnetic tampering output pulses, whose on/off ratio
    reflects the scale of the magnetic field. This sets the ratio at which mag netic tampering is
    declared. */
...
#define DEFAULT_V_RMS_SCALE_FACTOR_A                9520
#define DEFAULT_V_RMS_LIMP_SCALE_FACTOR             21280
#define DEFAULT_I_RMS_SCALE_FACTOR_A                11165//5348
#define DEFAULT_I_RMS_LIMP_SCALE_FACTOR             3537

#define DEFAULT_P_SCALE_FACTOR_A_LOW                3350//6365        /* Low current, high , range. Test at 2A on 30A max meter */

#define DEFAULT_V_PRESCALE_FACTOR                   34
...
#define DEFAULT_BASE_PHASE_A_CORRECTION_LOW         223//0x0ff   /* Low current, high gain, range. Test at 2A on 30A max meter. */
